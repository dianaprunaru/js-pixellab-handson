    ...
    function renderSkillsUl(skill) {
      ...
      $ul
        ...
        .on('click', '.saveSkillButton', function () {
          ...
          $saveButton.hide();
          $saveButton.siblings('.cancelButton').hide();
        });
...
//       let personDisplay = $(`.${personDisplay}`);
...
//             // $saveButton.hide();
//             // $saveButton.siblings('.cancelButton').hide();
//             // $saveButton.siblings.apply('.skillDisplay').show();
//             // $saveButton.siblings('.removeSkillButton').show();
//             // $saveButton.siblings.apply('.editSkillButton').show();
//           });
